...
- **Backend work**: Read `.pi/docs/backend-conventions.md` before writing backend code
- **Frontend work**: Read `.pi/skills/frontend-rules/SKILL.md` before writing frontend code
...
- Follow the `e2e-test-creator` skill conventions (`.pi/skills/e2e-test-creator/SKILL.md`) for structure and patterns.
...
7. **i18n Files - use the `i18n-editor` subagent**
   ...
   - **Repository-owned locale JSON.** All locale files are maintained directly in this repository. Update the relevant locale JSON files when changing user-facing translations, and keep their keys aligned across supported locales.
