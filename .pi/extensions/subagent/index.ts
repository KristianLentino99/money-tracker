...
export default function (pi: ExtensionAPI) {
  pi.registerTool({
    ...
    description: [
      ...
      `Default agent scope is "both" (user agents from ${path.join(getAgentDir(), 'agents')} and project agents from ${CONFIG_DIR_NAME}/agents).`,
      `Use agentScope: "project" to restrict delegation to project-local agents.`,
    ].join(' '),
