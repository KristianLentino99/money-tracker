---
name: worktree
description: Manage git worktrees for parallel Pi sessions. Use when user says "worktree", "create worktree", "parallel session", "new tree", or wants to work on multiple branches simultaneously.
allowed-tools: bash, find
---

# Git Worktree Manager

Manage git worktrees for running parallel Pi sessions.
...
7. **CRITICAL - Output this format at the end:**
   ...
   To start a parallel Pi session, copy and run:
   ┌────────────────────────────────────────────────────────────┐
