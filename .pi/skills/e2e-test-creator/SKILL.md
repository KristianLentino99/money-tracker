...
Before writing backend test code, read `.pi/docs/backend-conventions.md`. Then read these files to understand what you're testing:
...
After writing the test, delegate execution to the `test-runner` project agent:
