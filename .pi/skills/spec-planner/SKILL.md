...
Ask one focused question per turn repeatedly to probe deeply. Ask one focused question per turn, while keeping the full question backlog internally. Structure questions across these dimensions:
