...
| Tool   | Purpose                                              |
| ------ | ---------------------------------------------------- |
| `bash` | Search and fetch web content with command-line tools |
...
2. **Choose the right tool:**
   - Use `curl` or another available command-line HTTP client for web searches and documentation lookup
   - Use `curl` for extracting content from specific URLs the user provides
