...
const EXPECTED_GUARDED_COLUMNS: Record<string, string[]> = {
  ...
  'manual-portfolio-transactions': ['portfolioId'],
  'manual-portfolio-valuations': ['portfolioId'],
  'loan-details': ['accountId'],
  'payee-aliases': ['payeeId'],
  'payee-tags': ['payeeId', 'tagId'],
  payees: ['defaultCategoryId'],
  'plan-account-memberships': ['accountId', 'planId'],
  ...
  subscriptions: ['accountId', 'categoryId', 'loanAccountId', 'payeeId'],
  'tag-reminders': ['tagId'],
